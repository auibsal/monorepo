...
export const insertSubmissionSchema = z.object({
  ...
  file_url: z.string().url('Must be a valid URL').refine(val => val.startsWith('http://') || val.startsWith('https://'), { message: 'URL must use http or https protocol' }).nullable().optional(),
});
