      ...
      return (
        <>
          ...
          {nexusUrl && (
            <a
              href={nexusUrl}
              className="text-sm font-bold tracking-widest text-white uppercase transition-colors hover:text-auib-charcoal rounded-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-auib-red"
            >
              Nexus
            </a>
          )}
    ...
    >
      <div className="mx-auto flex h-20 max-w-6xl items-center justify-between px-6">
        <Link
          ...
          className="flex items-center text-white transition-opacity hover:opacity-90 rounded-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-auib-red"
        >
              ...
              {links.map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
                    onClick={() => setIsOpen(false)}
                    className="block py-2 transition-transform duration-200 hover:translate-x-2 hover:text-auib-red rtl:hover:-translate-x-2 rounded-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-auib-charcoal"
                  >
                    {link.label}
                  </Link>
                </li>
