              ...
              {links.map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
                    onClick={() => setIsOpen(false)}
                    className="block py-2 transition-transform duration-200 hover:translate-x-2 hover:text-auib-red rtl:hover:-translate-x-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-auib-red focus-visible:ring-offset-2 focus-visible:ring-offset-auib-charcoal rounded-sm"
                  >
                    {link.label}
                  </Link>
                </li>
