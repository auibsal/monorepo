...
const ToolbarButton = ({
  ...
  <button
    ...
    className={cn(
      'hover:border-auib-red border-2 border-transparent p-2 transition-colors focus-visible:outline-none',
...
export function RichTextEditor({
  ...
  return (
    <div className="border-auib-charcoal focus-within:border-auib-red flex w-full max-w-full flex-col overflow-hidden border-4 bg-white transition-colors">
      <div className="border-auib-charcoal bg-auib-charcoal flex w-full flex-wrap gap-1.5 border-b-4 p-2">
        <ToolbarButton
          label="Bold"
      ...
      <EditorContent
        editor={editor}
        className="prose text-auib-charcoal w-full max-w-none flex-1 overflow-x-hidden bg-transparent"
      />
    </div>
  );
}
