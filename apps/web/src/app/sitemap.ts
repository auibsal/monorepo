...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  // ⚡ Bolt: Execute independent Supabase queries concurrently to eliminate network waterfall.
  // Reduces sitemap generation time by resolving all three database calls simultaneously.
  const [
    { data: issues },
    { data: posts },
    { data: submissions }
