...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  // ⚡ Bolt Optimization: Batch independent database queries using Promise.all
  // to prevent network waterfalls and maximize concurrency during sitemap generation.
