...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  // ⚡ Bolt: Batch independent Supabase queries concurrently using Promise.all
  // This prevents a network waterfall and reduces total database roundtrip time to the maximum of the three queries.
