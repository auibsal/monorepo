...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  // ⚡ Bolt Optimization: Executed independent Supabase queries concurrently with Promise.all to eliminate network waterfall and improve sitemap generation performance.
