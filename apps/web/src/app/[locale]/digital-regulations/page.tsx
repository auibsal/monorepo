      ...
      <article className="w-full lg:w-3/4 space-y-20">
        ...
        <header className="border-b-2 border-black/30 pb-12">
          <div className="flex items-center gap-4 mb-6">
            ...
            <span className="text-sm font-mono text-association-black/60">IDA-DHP-2026</span>
          </div>
        ...
        <section id="preamble" className="scroll-mt-32">
          ...
          <div className="bg-black/5 p-8 rounded-sm border border-black/10 space-y-4 font-light opacity-80 leading-relaxed text-justify">
            <p>
              <strong className="text-association-black font-semibold">0.1 Online Play with Supervision:</strong> An event where players compete from their own remote locations (e.g., their homes) but are actively monitored by an Arbiter via a Video Conferencing System (VCS) and screen-sharing technology.
            </p>
            <p>
        ...
        <section id="playing-zone" className="scroll-mt-32">
          ...
          <div className="space-y-4 font-light opacity-80 leading-relaxed text-justify">
            ...
            <p className="font-bold text-association-black mt-4">1.1 Enforced Legality</p>
            <p>
            ...
            <p className="font-bold text-association-black mt-4">1.2 Virtual Clocks & Automation</p>
            <p>
        ...
        <section id="supervision" className="scroll-mt-32">
          ...
          <div className="space-y-4 font-light opacity-80 leading-relaxed text-justify">
            ...
            <ul className="list-disc pl-6 space-y-2 mt-4">
              <li><strong className="text-association-black font-semibold">Field of View:</strong> The webcam must provide a full view of the player's face and upper torso. Virtual backgrounds are strictly forbidden.</li>
              <li><strong className="text-association-black font-semibold">Microphone Mandate:</strong> Because dominoes is a 2v2 sport, preventing secret communication between partners is paramount. Microphones must remain <strong>ON</strong> and unmuted at all times. If an Arbiter detects whispering, secondary audio feeds, or suspicious ambient noise, they may immediately pause the game and initiate an investigation.</li>
              <li><strong className="text-association-black font-semibold">Screen Sharing:</strong> Players may be required to share their entire desktop screen (including the taskbar) with the Arbiter to prove no secondary communication apps (Discord, WhatsApp) or algorithmic calculators are running.</li>
            </ul>
          </div>
        </section>
        ...
        <section id="disconnections" className="scroll-mt-32">
          ...
          <div className="space-y-4 font-light opacity-80 leading-relaxed text-justify bg-white p-8 border border-black/20 rounded-sm shadow-xl">
            ...
            <p className="font-bold text-association-black mt-4">3.1 Clock Continuation</p>
            <p>
            ...
            <p className="font-bold text-association-black mt-4">3.2 Time Forfeiture</p>
            <p>
            ...
            <p className="font-bold text-association-black mt-4">3.3 VCS Disconnects (Yellow/Red Card)</p>
            <p>
        ...
        <section id="fair-play" className="scroll-mt-32">
          ...
          <div className="space-y-4 font-light opacity-80 leading-relaxed text-justify">
            ...
            <p className="font-bold text-association-black mt-4">4.3 Post-Match Investigations</p>
            <p>
        ...
        <section id="hybrid" className="scroll-mt-32">
          ...
          <div className="space-y-4 font-light opacity-80 leading-relaxed text-justify">
            ...
            <p className="font-bold text-association-black mt-4">5.1 Local Chief Arbiter (LCA)</p>
            <p>
            ...
            <p className="font-bold text-association-black mt-4">5.2 Technical Infrastructure</p>
            <p>
