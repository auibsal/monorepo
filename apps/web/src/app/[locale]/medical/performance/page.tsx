  ...
  return (
    <div className="max-w-6xl mx-auto py-24 px-6 lg:px-12 w-full">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 bg-black/5 border border-black/10 p-10 rounded-sm">
        ...
        <div className="bg-white border border-black/20 p-10 rounded-sm">
          <h2 className="text-xl font-bold uppercase tracking-wide mb-6 border-b border-black/20 pb-4">
          ...
          <ul className="space-y-4">
            <li className="flex flex-col">
              <span className="font-bold text-sm uppercase tracking-wider text-association-black">Omega-3 (EPA/DHA)</span>
              <span className="font-mono text-xs opacity-60 mt-1">Cognitive maintenance</span>
            </li>
            <li className="flex flex-col">
              <span className="font-bold text-sm uppercase tracking-wider text-association-black">Creatine Monohydrate</span>
              <span className="font-mono text-xs opacity-60 mt-1">Cellular ATP production</span>
            </li>
            <li className="flex flex-col">
              <span className="font-bold text-sm uppercase tracking-wider text-association-black">L-Theanine & Caffeine</span>
              <span className="font-mono text-xs opacity-60 mt-1">Controlled focus without jitter</span>
            </li>
            <li className="flex flex-col">
              <span className="font-bold text-sm uppercase tracking-wider text-association-black">Electrolyte Hydration</span>
        ...
        <div className="lg:col-span-3 border-t border-black/10 pt-16 mt-8">
          <h2 className="text-2xl font-bold uppercase tracking-wide mb-6">Environmental & Ergonomic Factors</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div>
              <h3 className="text-lg font-bold uppercase mb-3 text-association-black/80">Table Posture</h3>
            ...
            <div>
              <h3 className="text-lg font-bold uppercase mb-3 text-association-black/80">Visual Strain</h3>
              <p className="font-light opacity-70 text-sm leading-relaxed">
