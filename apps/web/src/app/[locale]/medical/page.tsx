  ...
  return (
    <div className="w-full min-h-[85vh] flex flex-col">
      ...
      <section className="flex-grow max-w-7xl mx-auto w-full px-6 lg:px-12 py-24 grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        {/* Anti-Doping Node */}
        <Link href="/medical/anti-doping" className="group relative bg-white border border-black/10 p-12 overflow-hidden rounded-sm hover:border-red-500/50 transition-colors duration-500">
          ...
          <h3 className="text-2xl font-bold uppercase tracking-wide mb-4 text-association-black">Anti-Doping & WADA</h3>
        ...
        <Link href="/medical/performance" className="group relative bg-white border border-black/10 p-12 overflow-hidden rounded-sm hover:border-black/40 transition-colors duration-500">
          <div className="absolute top-0 right-0 w-32 h-32 bg-black/5 rounded-bl-full -z-10 group-hover:bg-black/10 transition-colors duration-500"></div>
          <span className="text-4xl mb-6 block opacity-80">🧠</span>
          <h3 className="text-2xl font-bold uppercase tracking-wide mb-4 text-association-black">Athletic Performance</h3>
          <p className="font-light opacity-70 leading-relaxed mb-8">
          ...
          <span className="text-sm font-bold uppercase tracking-widest text-association-black/60 group-hover:text-association-black transition-colors">
