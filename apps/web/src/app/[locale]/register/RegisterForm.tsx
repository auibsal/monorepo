...
export default function RegisterForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      >
        {status === 'loading' ? t('loading') : t('registerButton')}
      </button>

      <div className="text-center mt-4">
        <a href="login" className="text-auib-white/70 hover:text-auib-white hover:underline text-sm font-bold uppercase">Back to {t('loginTitle')}</a>
      </div>
    </form>
  );
}
