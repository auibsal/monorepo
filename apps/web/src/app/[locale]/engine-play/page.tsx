      ...
      <article className="w-full lg:w-3/4 space-y-20">
        ...
        <header className="border-b-2 border-black/30 pb-12">
          <div className="flex items-center gap-4 mb-6">
            ...
            <span className="text-sm font-mono text-association-black/60">IDA-ALG-2026</span>
          </div>
        ...
        <section id="proxy" className="scroll-mt-32">
          ...
          <div className="space-y-4 font-light opacity-80 leading-relaxed text-justify">
            ...
            <p className="font-bold text-association-black mt-4">1.1 Exemption from 'Touched Tile' Penalties</p>
            <p>
            ...
            <p className="font-bold text-association-black mt-4">1.2 Move Execution Sequence</p>
            <p>
        ...
        <section id="clocks" className="scroll-mt-32">
          ...
          <div className="space-y-4 font-light opacity-80 leading-relaxed text-justify">
            ...
            <p className="font-bold text-association-black mt-4">2.1 Accounting for Physical Delay</p>
            <p>
            ...
            <p className="font-bold text-association-black mt-4">2.2 Prohibition of Forced Moves</p>
            <p>
