      ...
      <article className="w-full lg:w-3/4 space-y-20">
        ...
        <header className="border-b-2 border-black/30 pb-12">
          <div className="flex items-center gap-4 mb-6">
            ...
            <span className="text-sm font-mono text-association-black/60">EFFECTIVE JAN 2026</span>
          </div>
        ...
        {/* PREFACE */}
        <section id="preface" className="scroll-mt-32 bg-black/5 p-8 rounded-sm border border-black/10">
        ...
        <section id="part-1" className="scroll-mt-32">
          <h2 className="text-4xl font-bold uppercase tracking-wide mb-2 text-transparent bg-clip-text bg-gradient-to-r from-association-black to-gray-800">
        ...
        <section id="art-1" className="scroll-mt-32">
          ...
          <div className="space-y-4 font-light opacity-80 leading-relaxed text-justify">
            <p><strong className="text-association-black font-semibold">1.1</strong> The competitive game of dominoes is played between two pairs of opponents (2 vs 2 format) who place their tiles on a flat surface called the 'board'.</p>
            <p><strong className="text-association-black font-semibold">1.2</strong> Teammates must sit directly opposite each other across the board.</p>
            <p><strong className="text-association-black font-semibold">1.3</strong> The objective of each player is to connect the pips (dots) on their tiles with the exposed open ends on the board, systematically emptying their hand while attempting to restrict the opponents' ability to do the same.</p>
            <p><strong className="text-association-black font-semibold">1.4</strong> The pair who successfully plays all their tiles, or holds the lowest mathematical pip count when the board is locked, wins the hand.</p>
          </div>
        </section>
        ...
        <section id="art-2" className="scroll-mt-32">
          ...
          <div className="space-y-4 font-light opacity-80 leading-relaxed text-justify">
            <p><strong className="text-association-black font-semibold">2.1</strong> A standard "Double-Six" set is utilized, comprising exactly 28 tiles.</p>
            <p><strong className="text-association-black font-semibold">2.2 The Shuffle (Washing):</strong> At the beginning of a hand, all 28 tiles are placed face down. The designated player must mix the tiles using flat, circular motions with both hands.</p>
            <p className="pl-6 border-l-2 border-black/30 text-sm">
              <strong className="text-association-black">2.2.1</strong> During the shuffle, the other three players must keep their hands off the table and in plain sight.
            </p>
            <p><strong className="text-association-black font-semibold">2.3 The Draw:</strong> Beginning with the player to the right of the shuffler, each player draws exactly seven (7) tiles. There is no boneyard (reserve tiles) left over in sanctioned 2v2 play; all 28 tiles are distributed.</p>
          </div>
        </section>
        ...
        <section id="art-3" className="scroll-mt-32">
          ...
          <div className="space-y-4 font-light opacity-80 leading-relaxed text-justify">
            <p><strong className="text-association-black font-semibold">3.1</strong> It is only permitted to play a tile if one of its numerical halves matches an exposed, open end of the domino chain on the board.</p>
            <p><strong className="text-association-black font-semibold">3.2 The Spinner:</strong> A "Double" tile (a tile with identical numbers on both halves, e.g., 6-6) must be placed perpendicularly across the line of play. Singles are placed parallel to the line of play.</p>
            <p><strong className="text-association-black font-semibold">3.3 Passing:</strong> If a player does not possess a matching tile, they must clearly declare "Pass" or knock the table lightly.</p>
        ...
        <section id="art-4" className="scroll-mt-32">
          ...
          <div className="space-y-4 font-light opacity-80 leading-relaxed text-justify">
            <p><strong className="text-association-black font-semibold">4.1</strong> Each move must be played with one hand only.</p>
            <p><strong className="text-association-black font-semibold">4.2</strong> A player may not hover their tile over the board to "test" connections. The move must be swift and decisive.</p>
            <p><strong className="text-association-black font-semibold">4.3 Finality of Move:</strong> When, as a legal move, a tile has been released onto the board and the player's fingertips have broken physical contact with it, the move is considered completed. It cannot be retracted or moved to the other exposed end of the chain.</p>
          </div>
        </section>
        ...
        <section id="art-5" className="scroll-mt-32">
          ...
          <div className="space-y-4 font-light opacity-80 leading-relaxed text-justify">
            <p><strong className="text-association-black font-semibold">5.1 Domination:</strong> The hand is won immediately when a player places their final tile onto the board, emptying their hand. This concludes the hand.</p>
            <p><strong className="text-association-black font-semibold">5.2 The Lock (Block):</strong> The hand is drawn/locked when neither of the exposed ends on the board can be matched by any tile remaining in any player's possession.</p>
            <p className="pl-6 border-l-2 border-black/30 text-sm">
              <strong className="text-association-black">5.2.1</strong> Upon a Lock, all players must expose their remaining tiles. The team with the lowest combined total of pips (dots) wins the hand.
            </p>
          </div>
        </section>
        ...
        <section id="art-6" className="scroll-mt-32">
          ...
          <div className="space-y-4 font-light opacity-80 leading-relaxed text-justify">
            <p><strong className="text-association-black font-semibold">6.1</strong> In Tier 1 and Tier 2 rated events, a central match clock or digital timer may be utilized to govern the pace of play.</p>
            <p><strong className="text-association-black font-semibold">6.2 Time Control:</strong> Unless otherwise specified by the tournament regulations, a player has a maximum of twenty (20) seconds to execute their move or declare a pass.</p>
            <p><strong className="text-association-black font-semibold">6.3 Stalling:</strong> Intentional slow-play designed to disrupt the rhythm of the game or annoy opponents is forbidden and subject to point deductions by the Arbiter.</p>
          </div>
        </section>
        ...
        <section id="art-7" className="scroll-mt-32">
          ...
          <div className="space-y-4 font-light opacity-80 leading-relaxed text-justify">
            <p><strong className="text-association-black font-semibold">7.1 Exposed Tiles During Shuffle:</strong> If a tile is accidentally flipped face-up during the shuffle, the shuffle is immediately voided and must be completely restarted by the same player.</p>
            ...
            <p><strong className="text-association-black font-semibold">7.3 Out of Turn Play:</strong> If a player exposes or plays a tile when it is not their turn, the tile is returned to their rack, and the Arbiter shall issue a formal warning. A second offense yields a 25-point penalty.</p>
          </div>
        </section>
        ...
        <section id="art-8" className="scroll-mt-32">
          ...
          <div className="space-y-4 font-light opacity-80 leading-relaxed text-justify">
            <p><strong className="text-association-black font-semibold">8.1 The IDA Platform:</strong> Paper scoresheets are strictly prohibited for official ELO calculations. All match scores must be recorded on the official digital terminal provided at the table.</p>
            <p><strong className="text-association-black font-semibold">8.2 Live Entry:</strong> At the conclusion of each hand, the winning team dictates the opposing team's remaining pip count to the Arbiter or inputs it directly into the terminal.</p>
        ...
        <section id="art-9" className="scroll-mt-32">
          ...
          <div className="space-y-4 font-light opacity-80 leading-relaxed text-justify">
            <p><strong className="text-association-black font-semibold">9.1 Tied Lock:</strong> If a Lock occurs (per Article 5.2) and both opposing teams hold an identical combined pip count, the hand is declared a Dead Heat (Void).</p>
            <p><strong className="text-association-black font-semibold">9.2</strong> In the event of a Tied Lock, no points are awarded to either team. The hand is effectively erased, and the turn to shuffle and open the next hand rotates counter-clockwise to the next player in sequence.</p>
          </div>
        </section>
        ...
        <section id="art-10" className="scroll-mt-32">
          ...
          <div className="space-y-4 font-light opacity-80 leading-relaxed text-justify">
            <p><strong className="text-association-black font-semibold">10.1 Scoring Domination:</strong> The winning team scores the sum total of all pips remaining on the tiles held by the opposing team.</p>
            <p><strong className="text-association-black font-semibold">10.2 Scoring a Lock:</strong> The team with the lowest combined pip count wins, and scores the combined pip count of the losing team.</p>
        ...
        <section id="art-11" className="scroll-mt-32">
          ...
          <div className="space-y-4 font-light opacity-80 leading-relaxed text-justify">
            <p><strong className="text-association-black font-semibold">11.1</strong> The players shall take no action that will bring the sport of dominoes into disrepute.</p>
            <p><strong className="text-association-black font-semibold">11.2 Silence During Play:</strong> From the moment the draw begins until the hand concludes, strict silence regarding the game state is mandated. "Table talk," including discussing strategy or remaining tiles, is strictly prohibited.</p>
            <p className="pl-6 border-l-2 border-red-500/50 text-sm">
            ...
            <p><strong className="text-association-black font-semibold">11.3 Devices:</strong> Players are forbidden to use mobile phones or electronic devices in the playing area. Devices must be powered off and stored in bags.</p>
          </div>
        </section>
        ...
        <section id="art-12" className="scroll-mt-32">
          ...
          <div className="space-y-4 font-light opacity-80 leading-relaxed text-justify">
            <p><strong className="text-association-black font-semibold">12.1</strong> The Arbiter shall see that the Laws of Dominoes are observed with absolute strictness.</p>
            <p><strong className="text-association-black font-semibold">12.2</strong> The Arbiter shall act in the best interest of the competition, ensuring a professional playing environment free from external disturbance.</p>
            <p><strong className="text-association-black font-semibold">12.3 Penalties:</strong> The Arbiter possesses the unilateral power to impose penalties, including warnings, point deductions, immediate forfeiture of a hand, or expulsion from the competition venue.</p>
          </div>
        </section>
        ...
        <section id="appendices" className="scroll-mt-32">
          <h2 className="text-4xl font-bold uppercase tracking-wide mb-8 text-transparent bg-clip-text bg-gradient-to-r from-association-black to-gray-800">
            3.0 Appendices & Glossary
          </h2>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-black/5 p-6 rounded-sm border border-black/10">
              <h4 className="font-bold uppercase tracking-widest text-sm text-association-black/60 mb-2">Appendix A</h4>
            ...
            <div className="bg-black/5 p-6 rounded-sm border border-black/10">
              <h4 className="font-bold uppercase tracking-widest text-sm text-association-black/60 mb-2">Appendix B</h4>
          ...
          <div className="mt-12">
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4 border-b border-black/10 pb-4">
                <div className="font-bold text-association-black">Boneyard</div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4 border-b border-black/10 pb-4">
                <div className="font-bold text-association-black">Pip</div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4 border-b border-black/10 pb-4">
                <div className="font-bold text-association-black">Spinner</div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4 border-b border-black/10 pb-4">
                <div className="font-bold text-association-black">Double</div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4 border-b border-black/10 pb-4">
                <div className="font-bold text-association-black">ELO</div>
