    ...
    <div className="min-h-screen bg-[#050505] text-white selection:bg-red-600 selection:text-white font-sans overflow-hidden relative">
      ...
      <div className="bg-red-600 text-black font-mono text-xs font-bold uppercase tracking-[0.2em] whitespace-nowrap overflow-hidden border-b border-red-800 py-2 relative z-10">
        <div className="animate-marquee inline-block">
          <span className="mx-6">● OFFICIAL I.D.A. SANCTIONED EVENT</span>
          <span className="mx-6">|</span>
          <span className="mx-6 text-white">FEDERATION NOTICE: BONE-YARD PROTOCOLS ENFORCED</span>
          <span className="mx-6">|</span>
          <span className="mx-6">RANKINGS UPDATE: WORLD CHAMPIONSHIP QUALIFIERS</span>
          <span className="mx-6">|</span>
          <span className="mx-6 text-white">IS-MCTS ENGINE V1.0 MAINTAINS 99.8% ACCURACY</span>
          <span className="mx-6">|</span>
        </div>
      </div>
      ...
      <main className="relative z-10 flex flex-col lg:flex-row min-h-[90vh]">
        ...
        <div className="flex-1 flex flex-col justify-center p-8 md:p-16 lg:p-24 relative z-10 border-r border-white/5">
          <div className="flex items-center gap-4 mb-8">
            ...
            <span className="text-red-500 font-mono text-xs uppercase tracking-[0.4em]">The Governing Body</span>
          </div>
          ...
          <h2 className="text-6xl md:text-8xl lg:text-[7rem] font-black uppercase leading-[0.85] tracking-tighter mb-8 relative">
            <span className="text-transparent [-webkit-text-stroke:2px_rgba(255,255,255,0.2)] block hover:[-webkit-text-stroke:2px_white] transition-colors duration-500">Preserve</span>
            <span className="text-white block">The Heritage.</span>
            <span className="text-transparent [-webkit-text-stroke:2px_rgba(255,255,255,0.2)] block hover:[-webkit-text-stroke:2px_white] transition-colors duration-500">Master</span>
            <span className="text-white block">The Board.</span>
          </h2>
          ...
          <div className="flex flex-col sm:flex-row gap-6 items-start">
            <Link href="/arena" className="group relative bg-white text-black font-bold uppercase tracking-[0.2em] px-10 py-5 overflow-hidden">
              ...
              <span className="relative z-10 group-hover:text-white transition-colors duration-500">Enter Sanctioned Play</span>
            </Link>
        ...
        <div className="flex-1 flex items-center justify-center relative p-8 lg:p-0 overflow-hidden">
          ...
          <div className="absolute top-1/4 right-[10%] bg-black/60 backdrop-blur-md border border-white/10 p-5 font-mono text-xs hidden lg:block shadow-2xl transform rotate-3 hover:rotate-0 transition-transform">
            <div className="flex items-center gap-2 border-b border-white/10 pb-2 mb-2">
              ...
              <span className="text-white/60 tracking-widest">ENGINE TELEMETRY</span>
            </div>
            <p className="text-3xl font-light text-white mb-1">+4.23</p>
            <p className="text-white/40">IS-MCTS Depth: 10,000</p>
          </div>
          ...
          <div className="absolute bottom-1/4 left-[10%] bg-black/60 backdrop-blur-md border border-white/10 p-5 font-mono text-xs hidden lg:block shadow-2xl transform -rotate-2 hover:rotate-0 transition-transform">
            <div className="flex items-center gap-2 border-b border-white/10 pb-2 mb-2">
              ...
              <span className="text-white/60 tracking-widest">FEDERATION RULE</span>
            </div>
            <p className="text-xl font-light text-white mb-1">Victor's Privilege</p>
            <p className="text-white/40">Strategic Opening Authorized</p>
          </div>
        </div>
      </main>
