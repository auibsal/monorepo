...
export const Footer = () => {
  return (
    <footer className="bg-white border-t-4 border-association-black text-association-black font-mono relative overflow-hidden z-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 mb-20">
          ...
          <div className="col-span-1 md:col-span-5 pr-8">
            <div className="flex items-center gap-4 mb-6">
              ...
              <h2 className="text-association-black text-2xl font-black tracking-tighter uppercase">Iraqi Domino<br/>Association</h2>
            </div>
          ...
          <div className="col-span-1 md:col-span-3 flex flex-col gap-5 bg-association-white border border-black/10 p-6 shadow-sm">
