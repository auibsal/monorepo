...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en">
      <body className="bg-zinc-950 text-zinc-50 flex h-screen overflow-hidden font-sans">
        {/* Sidebar */}
        <aside className="w-64 border-r border-zinc-900 bg-zinc-950 flex flex-col">
          ...
          <div className="p-4 border-t border-zinc-900">
            <Link href="/settings" className="flex items-center gap-3 px-3 py-2 text-sm text-zinc-500 hover:text-zinc-300">
