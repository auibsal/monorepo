...
export default function UsersPage() {
  ...
  useEffect(() => {
    ...
    const fetchUsers = async () => {
      ...
      // ⚡ Bolt Optimization: Prevent payload bloat by explicitly fetching only the columns required for the table, avoiding the transfer of avatar_url and biography.
