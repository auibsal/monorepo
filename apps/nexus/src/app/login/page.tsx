  ...
  return (
    <form onSubmit={handleLogin} className="space-y-8">
      ...
      <button
        ...
        className="flex w-full items-center justify-center gap-3 border-4 border-border bg-foreground p-4 font-bold tracking-widest text-background uppercase shadow-[6px_6px_0px_0px_var(--brutalist-shadow)] transition-all hover:-translate-y-1 hover:border-primary hover:bg-primary hover:shadow-[8px_8px_0px_var(--brutalist-shadow)] focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-background focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50"
      >
        {status === 'loading' ? (
          <>
      ...
      <div className="mt-8 border-t-4 border-border pt-8 text-center">
        <Link
          href="/register"
          className="inline-block text-sm font-bold tracking-wider text-foreground uppercase transition-colors hover:-translate-y-0.5 hover:text-primary focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-background focus-visible:outline-none"
        >
          Create an Account
        </Link>
      </div>
