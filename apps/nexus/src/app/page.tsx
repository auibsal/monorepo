...
export default async function NexusHome() {
  ...
  if (isEditor) {
    // ⚡ Bolt Optimization: Selecting 'id' instead of '*' for count-only queries prevents PostgREST from parsing full row metadata and reduces PostgreSQL index evaluation time.
